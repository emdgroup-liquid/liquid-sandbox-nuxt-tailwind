...
<template>
  <div class="bg-wht rounded-l shadow-hover p-ld-32 block">
    <LdTypo variant="h2" class="mb-ld-32">Hi there 👋</LdTypo>

    <LdTypo class="mb-ld-16">
    ...
    <LdTypo class="mb-ld-24">Let's change the theme of the app first:</LdTypo>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-ld-24 items-center">
      <ld-label position="right" size="m">
        <span
          :class="{ 'text-rr': !termsAccepted && v$.termsAccepted?.$dirty }"
        >
